...
if(isset($_GET['submit']))
{
  ...
  $subcategory_name = check($_GET['subcategory_name']);
  

  $subcategory_insert= "insert into sub_category values(null,'$category_id','$subcategory_name')";
  

  //echo $product_insert;

  $insert = mysqli_query($conn,$subcategory_insert);


    //echo "fsdasd";
    header('Location: sub-category-details.php');
  
}

$view_query = "select * from sub_category s, category c where s.category_id = c.category_id";
  //echo $view_query;
  //echo "Sd";
